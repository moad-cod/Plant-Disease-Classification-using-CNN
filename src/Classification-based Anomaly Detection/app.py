...
def load_everything():
    ...
    model_path = '/home/snow/PycharmProjects/-Plant-Disease-Classification-using-CNN/src/Classification-based Anomaly Detection/plant-disease-model (5).pth'
    model_ok   = False
    ...
    # Anomaly params
    anomaly_params = None
    anom_path      = '/home/snow/PycharmProjects/-Plant-Disease-Classification-using-CNN/src/Classification-based Anomaly Detection/anomaly_params (1).pkl'
...
with tab_insights:
    ...
    with c_left:
        ...
        cm_path = 'confusion_matrix (4).png'
    ...
    with c_ov:
        ...
        ov_path = 'overfitting_analysis (5).png'
    ...
    with c_dist:
        ...
        dist_path = 'class_distribution (2).png'
    ...
    with c_msp:
        ...
        msp_path = 'msp_distribution (1).png'
    ...
    with c_goad:
        ...
        goad_path = 'goad_distribution (1).png'
...
# ─────────────────────────────────────────────
st.markdown("""
<div style="text-align:center;padding:2.5rem 0 1rem;color:#2a5a35;font-size:0.74rem;border-top:1px solid #1a2e1d;margin-top:2rem">
